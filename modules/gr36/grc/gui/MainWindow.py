...
class MainWindow(gtk.Window):
    ...
    def __init__(self, platform):
        ...
        self.reports_scrolled_window.set_policy(
        ...
        self.flow_graph_vpaned.pack2(
            self.reports_scrolled_window, False)  # dont allow resize
    ...
    def close_pages(self):
        ...
        """
        open_files = filter(lambda file: file,
                            self._get_files())  # filter blank files
        ...
        Preferences.reports_window_position(
            self.flow_graph_vpaned.get_position())
    ...
    def close_page(self, ensure=True):
        ...
        if not self.page_to_be_closed:
            self.page_to_be_closed = self.get_page()
        ...
        for page in self._get_pages():
            page.set_markup(
                Utils.parse_template(PAGE_TITLE_MARKUP_TMPL,
                                     # get filename and strip out file
                                     # extension
                                     title=os.path.splitext(
                                         os.path.basename(page.get_file_path()))[0],

...
class test_socket_message(unittest.TestCase):
    ...
    def test_udp_loopback(self):
        udp_server = gras.make('/grex/socket_message',
                               "UDP_SERVER", 'localhost', '34567', 0)
        udp_client = gras.make('/grex/socket_message',
                               "UDP_CLIENT", 'localhost', '34567', 0)
    ...
    def test_tcp_loopback(self):
        tcp_server = gras.make('/grex/socket_message',
                               "TCP_SERVER", 'localhost', '34567', 0)
        tcp_client = gras.make('/grex/socket_message',
                               "TCP_CLIENT", 'localhost', '34567', 0)
        ...
        tcp_client2 = gras.make('/grex/socket_message',
                                "TCP_CLIENT", 'localhost', '34567', 0)
        # must be first to establish new connection
        self.do_loop(tcp_client2, tcp_server)
